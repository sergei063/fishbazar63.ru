...
import AllPlacesOfDeliveryDataTable from "./AllPlacesOfDeliveryDataTable/AllPlacesOfDeliveryDataTable";
            ...
            <div className={css(DeliveryStyle.flexContainer)}>
                <div className={css(DeliveryStyle.imgDiv)}>
                    <img
                        ...
                        srcSet={`${require('../../img/design/deliveryman/deliveryman2x.png')} 2x, 
                                 ${require('../../img/design/deliveryman/deliveryman3x.png')} 3x`}
                    />
                </div>
                                ...
                                axios
                                    ...
                                    .then(response => {
                                        if (response.data.auth_token) {
                                            ...
                                            props.history.push({ pathname: '/fbadmin' })
                                        }
