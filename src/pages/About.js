...
const About = () => (
    <div>
        Рыба - наш семейный бизнес. Уже более 20&nbsp;лет мы&nbsp;поставляем высококачественные, свежемороженные морепродукты с&nbsp;Дальнего Востока для оптовой торговли.
        ...
        мы&nbsp;динамично развиваем направление розничной торговли!
        ...
        в&nbsp;интернет магазин &laquo;Фиш базар&raquo;, а&nbsp;мы&nbsp;всегда будем радовать Вас качественными морепродуктами.
    </div>
)
