    ...
    items: [
      {
        ...
        html_text:
          '<p>Оливковое масло налейте в&nbsp;просторную сковороду, добавьте чеснок и&nbsp;нагревайте на&nbsp;маленьком огне не&nbsp;менее 10&nbsp;минут. Чеснок должен начать подрумяниться.</p>\n'
      ...
      },
      {
        ...
        html_text:
          '<p><span>Заранее из&nbsp;пергамента вырезать 8&nbsp;кругов диаметром 14&nbsp;см. Рыбу вымыть, обсушить. Лук очистить, нарезать тонкими полукольцами. Перцы вымыть, разрезать пополам и&nbsp;удалить сердцевину, нарезать тонкой соломкой. Укроп вымыть, обсушить и&nbsp;измельчить.</span></p>\n'
      ...
      },
      {
        ...
        html_text:
          '<p><span>Нарежьте сливочное масло кубиками, положите в&nbsp;сотейник и&nbsp;растопите на&nbsp;среднем огне. Немного остудите. Натрите апельсиновую цедру на&nbsp;мелкой терке.</span></p>\n'
      ...
      },
      {
        ...
        html_text:
          '<p><span>Форель очистить, выпотрошить и&nbsp;тщательно промыть. Удалить голову, хвост и&nbsp;плавники.</span></p>\n'
    ...
    items: [
      {
        ...
        html_text:
          '<p>Вскипятите воду в&nbsp;кастрюле. Положите рисовую лапшу и&nbsp;варите 5&nbsp;мин., до&nbsp;готовности. Откиньте на&nbsp;дуршлаг, затем промойте холодной водой. Остудите.</p>\n'
      ...
      },
      {
        ...
        html_text:
          '<p><span>На&nbsp;разогретую сковороду выливаем немного оливкового масла. Когда оно закипит, выкладываем на&nbsp;сковороду немного раздавленные чесночные зубчики. Обжариваем&nbsp;их, пока они не&nbsp;пожелтеют. Далее выкладываем креветки (в&nbsp;панцире или без) и&nbsp;обжариваем их&nbsp;на&nbsp;сильном огне <nobr>(1-2 мин),</nobr> сбрызнув соевым соусом.</span></p>\n'
    ...
    items: [
      {
        ...
        to_refill: [],
        html_text:
          '<p>Разморозьте гребешки, затем обжарьте на&nbsp;оливковом масле на&nbsp;медленном огне. Приправить гребешки солью и&nbsp;перцем. Чеснок очистить, измельчить и&nbsp;смешать с&nbsp;мукой. Обвалять в&nbsp;этой смеси гребешки.Обжарить гребешки в&nbsp;разогретом масле, по&nbsp;2-3&nbsp;мин.&nbsp;с&nbsp;каждой стороны. Переложить на&nbsp;блюдо.</p>\n'
      ...
      },
      {
        ...
        html_text:
          '<p><span>Размораживать кальмары, следует либо в&nbsp;холодильнике, либо при комнатной температуре. </span></p>\n'
          + '<p><b><br/>\n'
          + ' \t</b> \n'
          + '</p>\n'
      ...
      },
      {
        ...
        html_text:
          '<p><span>Положите чеснок и&nbsp;зелень в&nbsp;чашу блендера и&nbsp;измельчите. Добавьте сливочное и&nbsp;оливковое масло, хлопья чили, посолите&shy; и&nbsp;поперчите. Хорошо перемешайте.</span></p>\n'
...
export const Recipes = {
  ...
  getAllItems: () => {
    let res = [];
    for (const el in Recipes.recipes) {
      const group = Recipes.recipes[el];
      if (group.catalog_tittle) {
        const r = group.items.map((recipe, index) => {
          recipe.parent = {};
          recipe.parent.id = el;
  ...
  getAllSordItems: (groupNameFilter) => {
    ...
    const items = groupNameFilter
      ? Recipes.getAllFilteredGroupItems(groupNameFilter)
      : Recipes.getAllItems();
  ...
  get(name) {
    ...
    for (const recipe in Recipes.recipes) {
      const group = Recipes.recipes[recipe];
      if (group.catalog_tittle) {
        const el = group.items.find(isProduct);
        if (el) {
          el.parent = {};
          el.parent.id = recipe;
...
const AllBlog = (props) => {
  const recipes = Recipes.getAllSordItems(
  ...
  return (
    <div className={css(AllBlogStyle.cnt, AllBlogStyle.cntBackground)}>
      <div
        className={css(
          AllBlogStyle.tabletShow,
          AllBlogStyle.menuBlogFilterStyle,
        )}
      >
        {' '}
        {MobileAgent.any() && <MenuBlogFilter history={props.history} />}
      </div>
      <div className={css(AllBlogStyle.cntFlex)}>
        <div style={{ width: '65%' }}>
          <div
            className={css(
              recipes.length > 0 ? AppStyle.displayNone : AppStyle.displayBlock,
            )}
          >
            В категории{' '}
            <span style={{ textTransform: 'lowercase' }}>
              {_try(() => props.history.location.state.blogFilter, '')}
            </span>{' '}
            пока нет рецептов.
          </div>
          ...
          {recipes.map((recipe, index) => (
            <div key={index.toString()}>
              ...
              <h2 className={css(AllBlogStyle.h2)}>
                {recipe.parent.catalog_tittle}
                &nbsp;&nbsp;|&nbsp;&nbsp;
                {recipe.dateObj.toLocaleString('ru', dateOptions)}{' '}
              </h2>
              <div>
                <img
                  className={css(AllBlogStyle.img)}
                  src={config.imgBlogRequire(recipe.img)}
                />
              </div>
        ...
        <div className={css(AllBlogStyle.tabletHide, AllBlogStyle.stickyBlock)}>
...
const noBlogText = props => (
  <div className={css(AllBlogStyle.cnt)}>
    <div className={css(AllBlogStyle.cntFlex)}>
      <div style={{ width: '65%' }}>
        <h1 className={css(AllBlogStyle.h1)}>
            В данной категории пока нет рецептов...
        </h1>
      </div>
      <div className={css(AllBlogStyle.tabletHide, AllBlogStyle.stickyBlock)}>
        <MenuBlog history={props.history} />
  ...
  <div>
    <Link
      onClick={(event) => {
        ...
        props.history.push({
          pathname: '/blog',
          state: { ...props.history.location.state, blogFilter: null },
        });
    ...
    <Link
      onClick={(event) => {
        ...
        props.history.push({
          ...
          state: {
            ...props.history.location.state,
            blogFilter: props.item.parent.catalog_tittle,
          },
        });
      }}
      className={css(SeafoodItemStyle.link)}
...
const OneBlog = (props) => {
  ...
  return (
    <div className={css(AllBlogStyle.cnt, AllBlogStyle.cntBackground)}>
      <div className={css(AllBlogStyle.mobileHide)}>
      ...
      <div className={css(AllBlogStyle.cntFlex)}>
        <div className={css(AllBlogStyle.recipeBlock)}>
          ...
          <h2 className={css(AllBlogStyle.h2)}>
            {selectedRecipe.parent.catalog_tittle}
            &nbsp;&nbsp;|&nbsp;&nbsp;
            {selectedRecipe.dateObj.toLocaleString('ru', dateOptions)}{' '}
          </h2>
          <div>
            <img
              className={css(AllBlogStyle.img)}
              src={config.imgBlogRequire(selectedRecipe.img)}
            />
          </div>
            ...
            {selectedRecipe.ingredients
              ...
              <div>
                <div className={css(AllBlogStyle.ingredientsHeader)}>
                  ...
                  <div
                    className={css(
                      AllBlogStyle.ingredientsSpan,
                      AllBlogStyle.ingredientsSpanPL40,
                    )}
                  >
                      Ингредиенты
                  </div>
                ...
                <ul className={css(AllBlogStyle.ingredientsUL)}>
                  {selectedRecipe.ingredients.map((ingredient, index) => (
                    <li
                      key={index.toString()}
                      className={css(AllBlogStyle.ingredientsLI)}
                    >
                      {ingredient}
                    </li>
                  ))}
          ...
          {selectedRecipe.to_refill
            && selectedRecipe.to_refill.length > 0 && (
            <div style={{ marginTop: '0px', marginBottom: '0px' }}>
              <span className={css(AllBlogStyle.ingredientsSpan)}>
                  Для заправки
              </span>
              <ul className={css(AllBlogStyle.ingredientsUL)}>
          ...
          {selectedRecipe.to_sauce
            && selectedRecipe.to_sauce.length > 0 && (
            <div style={{ marginTop: '0px', marginBottom: '0px' }}>
              <span className={css(AllBlogStyle.ingredientsSpan)}>
                  Для соуса
              </span>
          ...
          <div
            className={css(AllBlogStyle.recipeHtmlText)}
            dangerouslySetInnerHTML={{ __html: selectedRecipe.html_text || '' }}
          >
            {}
          </div>
        </div>
        <div className={css(AllBlogStyle.tabletHide, AllBlogStyle.stickyBlock)}>
          <MenuBlog
            ...
            fish_for_recipe={selectedRecipe.fish_for_recipe}
          />
        </div>
      </div>
...
class Blog extends React.Component {
    ...
    return (
      <Switch>
        <Route
          ...
          path="/blog"
          params={this.props}
          component={connect(mapStateToProps)(AllBlog)}
        />
        <Route
          path="/blog/:recipe"
          params={this.props}
          component={connect(mapStateToProps)(OneBlog)}
        />
      </Switch>
    );
  }
  ...
  componentDidMount() {
    axios.get(`${config.serverAPI}/blog`).then((res) => {
