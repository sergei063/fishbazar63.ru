  ...
  return (
    <div className={css(SeafoodItemStyle.cnt)}>
      ...
      <div className={css(SeafoodItemStyle.flexContainer)}>
        ...
        >
          <div className={css(SeafoodItemStyle.fishContainerFirst)}>
            <div
              className={css(
                SeafoodItemStyle.mobileShow650,
                SeafoodItemStyle.nameDiv,
              )}
            >
        ...
        >
          <div
            className={css(
              SeafoodItemStyle.mobileHidden650,
              SeafoodItemStyle.nameDiv,
            )}
          >
            <span className={css(SeafoodItemStyle.name)}>{item.name}</span>
          ...
          <div
            className={css(
              !item.weightOfOneFish
                ? AppStyle.hidden
                : SeafoodItemStyle.aboutFish,
            )}
          >
            ...
            <span className={css(SeafoodItemStyle.price)}>
              {item.packaging === 'кор'
                ? item.weightOfOneFish
                : Katalog.getWeightFishText(item)}{' '}
              кг
            </span>{' '}
            <br />
            Стоимость одной {item.packaging === 'кор'
              ? 'упаковки'
              : 'рыбы'} ~{' '}
            <span className={css(SeafoodItemStyle.price)}>
            ...
            <br />
            <span className={css(SeafoodItemStyle.hidden_text)}>
              вес может отличатся +/– 200гр
            </span>
          </div>
          ...
          <div
            className={css(
              item.packaging !== 'кор'
                ? SeafoodItemStyle.aboutDelivery
                : AppStyle.hidden,
            )}
          >
            Это весовой товар, после отправки заказа мы позвоним вам и сообщим
            точную стоимость одной рыбы
          </div>
          <div>
            <Iinfo
      ...
      <div className={css(SeafoodItemStyle.mobileHidden)}>
        ...
        <div className={css(SeafoodItemStyle.withBuy)}>
