                ...
                >
                    <div className={css(Style.salesFlex, Style.salesH1)}>
                        ...
                        <div className={css(Style.salesChild)}>
                            <div>&bull;</div>
                            <div>скидка 4%&nbsp;&mdash; Каждому новому покупателю</div>
                        </div>
                        <div className={css(Style.salesChild)}>
                            <div>&bull;</div>
                            <div>
                                скидка 5%&nbsp;&mdash; Каждому покупателю, кто делает у&nbsp;нас заказ не&nbsp;первый раз
                            </div>
                        </div>
                        <div className={css(Style.salesChild)}>
                            <div>&bull;</div>
                            <div>
                                скидка 7%&nbsp;&mdash; каждому, кто делает заказ на&nbsp;сумму от&nbsp;4&nbsp;000руб
                            </div>
                        </div>
                        <div className={css(Style.salesChild)}>
                            <div>&bull;</div>
                            <div>
                                все у&nbsp;кого уже есть скидка&nbsp;7% по&nbsp;условиям предыдущей системы лояльности- оставляем ее&nbsp;за&nbsp;Вами!
                            </div>
                        </div>
