    ...
    items: [
      {
        ...
        nutritionalValue:
          'Калории 140ккал<br/>                Белки. 20,5г<br/>            Жиры 6г<br/>            Углеводы. 0г<br/>            Омега3(г). 1,6г<br/>',
        hit: true,
      ...
      },
      {
        ...
        packagingInfo: 'Реализуется штучно. Ориентировочный вес 1-2 кг',
        nutritionalValue:
          'Калории 127ккал<br/>Белки. 19г<br/>Жиры 5,6г<br/>Углеводы. 0г<br/>Омега3(г). 1г',
        hit: true,
        weightOfOneFish: 1.9,
        weightFish: {
          help: '1-2кг',
        ...
        producer:
          'АО "Хайрюзовский рыбоконсервный завод" Россия Камчатский край Тигильский район с. Усть-Хайрюзово',
      ...
      },
      {
        ...
        packaging: 'шт',
        nutritionalValue:
          'Калории 140ккал<br/>                Белки. 21,6г<br/>            Жиры 6г<br/>            Углеводы. 0г<br/> Омега3(г). 0г',
      ...
      },
      {
        ...
        nutritionalValue:
          'Калории 208ккал<br/>Белки. 20,4г<br/>Жиры 13,4г<br/>Углеводы. 0г<br/>Омега3(г). 2,5г',
        hit: true,
...

      {
        ...
        weightOfOneFish: 2.7,
        nutritionalValue:
          'Калории 141ккал<br>Белки. 19,9г<br>Жиры 6,2г<br>Углеводы. 0г<br>Омега3(г). 0,9г',
        packagingInfo: 'Реализуется штучно.  Ориентировочный вес 2-3 кг',
        hit: false,
      ...
      },
      {
        ...
        packagingInfo: '',
        nutritionalValue:
          'Калории 69ккал<br/>                Белки. 15,3г<br/>            Жиры 0,4г<br/>            Углеводы. 3,3г<br/>            Омега3(г). 0,1г',
        hit: true,
      ...
      },
      {
        ...
        packagingInfo: '',
        nutritionalValue:
          'Калории 56ккал<br/>Белки. 12,2г<br/>Жиры 0,4г<br/>Углеводы. 0г<br/>Омега3(г). 0,2г',
        hit: true,
        img: require('./img/seafood/pollock.png'),
        producer:
          'ООО ПКФ"Южно-Курильский рыбокомбинат" Россия Сазалинская обл. п.г.т. Южно-Курильск',
      ...
      },
      {
        ...
        packagingInfo: '',
        nutritionalValue:
          'Калории 90ккал<br/>                Белки. 15,7г<br/>           Жиры 3г<br/>            Углеводы. 0г<br/>            Омега3(г). 0г',
        hit: false,
        img: require('./img/seafood/flounder.png'),
        producer:
          'ООО "Морские ресурсы" Россия САХАЛИНСКСАЯ ОБЛ., Г СЕВЕРО-КУРИЛЬСК',
            ...
            }, */
      {
        ...
        packagingInfo: '',
        nutritionalValue:
          'Калории 248ккал<br/>Белки. 17,7г<br/>Жиры 19,5г<br/>Углеводы. 0г<br/>Омега3(г). 0г',
        hit: false,
      ...
      },
      {
        ...
        info: '',
        nutritionalValue:
          'Калории 205ккал<br/>Белки. 18,6г<br/>Жиры 13,9г<br/>Углеводы. 0г<br/>Омега3(г). 2,7г',
        packaging: 'кг',
        packagingInfo: '',
        hit: false,
    ...
    items: [
      {
        ...
        hit: true,
        nutritionalValue:
          'Калории 77ккал<br>Белки. 11,5г<br>Жиры 2г<br>Углеводы. 3,3г<br>Омега3(г). 0г',
      ...
      },
      {
        ...
        packagingInfo: '',
        nutritionalValue:
          'Калории 100ккал<br/>                Белки. 18г<br/>            Жиры 2,2г<br/>            Углеводы. 2г<br/>            Омега3(г). 1,4г',
        hit: true,
        img: require('./img/seafood/squid.png'),
        producer:
          'АО "Северо-Курильская база Северного флота" Россия Сахалинская обл г Северо-Курильск',
    ...
    items: [
      {
        ...
        nutritionalValue:
          'Калории 87ккал<br/>Белки. 18,3г<br/>Жиры 1,2г<br/>Углеводы. 0,8г<br/>Омега3(г). 0,5г',
        hit: false,
      ...
      },
      {
        ...
        packaging: 'кор',
        nutritionalValue:
          'Калории 98ккал<br/>Белки. 20,5г<br/>Жиры 1,6г<br/>Углеводы. 0,3г<br/>Омега3(г). 0,3г',
        packagingInfo: '',
        hit: false,
    ...
    items: [
      {
        ...
        packaging: 'кор',
        nutritionalValue:
          'Калории 143ккал<br>Белки. 26,4г<br>Жиры 1,9г<br>Углеводы. 3,1г<br>Омега3(г). 0,5г',
        packagingInfo: '',
        hit: true,
        producer: 'Аргентина',
...
const Katalog = {
  ...
  setFishItem(fishGroup, fishItem) {
    const isFish = p => p.id === fishItem.id;

    const index = Katalog.price[fishGroup].items.findIndex(isFish);
    if (index >= 0) {
      if (!fishItem.img) {
  ...
  setPrice(price) {
    for (const groupName in price) {
      const group = price[groupName];
      if (group.catalog_tittle) {
        for (const fishName in group.items) {
          const fish = group.items[fishName];
  ...
  get(id) {
    ...
    for (const fish in Katalog.price) {
      const group = Katalog.price[fish];
      if (group.catalog_tittle) {
  ...
  delete(id) {
    for (const fish in Katalog.price) {
      const group = Katalog.price[fish];
      if (group.catalog_tittle) {
        for (const itemNum in group.items) {
  ...
  getGroup() {
    const r = [];
    for (const el in Katalog.price) {
      const group = Katalog.price[el];
      if (group.catalog_tittle) {
  ...
  getHitItems() {
    ...
    for (const fish in Katalog.price) {
      const group = Katalog.price[fish];
      if (group.catalog_tittle) {
        const filtredData = group.items.filter(isProduct);
        const el = filtredData.map((f) => {
          f.parent = {};
          f.parent.id = fish;
   ...
   * @returns {Array}
   */
  getGroupItems(groupName, filterCount) {
    if (groupName) {
      if (groupName === 'hit') {
    ...
    if (!filterCount) filterCount = this.FILTER_COUNT;
   ...
   * @returns {*}
   */
  getWithThisProductBuy(fishItem, countFishFoGroups) {
    const returnArr = [];
    const hitItems = Katalog.getHitItems();

    const redFish = hitItems
      .filter(
        fish => fish.parent.id === 'fish'
          && fish.isRedFish
          && fish.id !== fishItem.id,
      )
      .sort((a, b) => Math.random() - 0.5)
      .slice(0, 1)[0];
    const whiteFish = hitItems
      .filter(fish => fish.parent.id === 'fish' && !fish.isRedFish)
      .sort((a, b) => Math.random() - 0.5)
      .slice(0, 1)[0];
    const shrimpsAndLangoustines = hitItems
      .filter(
        fish => fish.parent.id === 'Shrimp'
          || (fish.parent.id === 'Langoustines' && fish.id !== fishItem.id),
      )
      .sort((a, b) => Math.random() - 0.5)
      .slice(0, 1)[0];
    const shellfish = hitItems
      .filter(
        fish => fish.parent.id === 'Shellfish' && fish.id !== fishItem.id,
      )
      .sort((a, b) => Math.random() - 0.5)
      .slice(0, 1)[0];
    ...
    if (fishItem.isRedFish) {
      ...
      fishItem.parent.id !== 'Shrimp'
      || fishItem.parent.id !== 'Langoustines'
    ) {
      returnArr[0] = redFish;
  ...
  getProductGroup(props, filter) {
    ...
    r.push(
      <span
        ...
        className={css(
          ProductionStyle.marginRight15,
          ProductionStyle.gpoupItem,
          AppStyle.center_text,
        )}
      >
        <span
          key={key}
          className={css(!filter ? AppStyle.link_active : AppStyle.link)}
        >
          Все
        </span>
      </span>,
      ...
      r.push(
        ...
        >
          <span
            key={key}
            className={css(
              filter === p.name ? AppStyle.link_active : AppStyle.link,
            )}
          >
            {' '}
            {p.catalog_tittle}
