...
const Slider = () => {
    ...
    <div id="slider" className={css(AppStyle.slider)}>
        ...
        <div className={css(AppStyle.siteTitle)}>
            ...
            <p id="slider_text_3" className={css(AppStyle.displayNone)} ><Link to='/production/shrimp_angular'>...Не нужно платить за лед.<br/>Наши креветки <u>100%</u> без глазури.</Link></p>
        </div>
