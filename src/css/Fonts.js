...
export const FuturaMediumFont = {
    fontFamily: "Futura-Medium",
    src: ' url("' + require('../fonts/Futura/FuturaMediumC/FuturaMediumC.eot') + '"), url("' + require('../fonts/Futura/FuturaMediumC/FuturaMediumC.eot?#iefix') + '") format("embedded-opentype"), url("' + require('../fonts/Futura/FuturaMediumC/FuturaMediumC.woff') + '") format("woff")',
};
export const FuturaBoldFont = {
    fontFamily: "Futura-Bold",
    src: ' url("' + require('../fonts/Futura/Futura-Bold/futura-bold.eot') + '"), url("' + require('../fonts/Futura/Futura-Bold/futura-bold.eot?#iefix') + '") format("embedded-opentype"), url("' + require('../fonts/Futura/Futura-Bold/futura-bold.woff') + '") format("woff")',
};
...
export const MetaSerifProBookFont = {
    fontFamily: "MetaSerifPro-Book",
    src: ' url("' + require('../fonts/MetaSerifPro/MetaSerifPro-Book/metaserifpro-book.eot') + '"), url("' + require('../fonts/MetaSerifPro/MetaSerifPro-Book/metaserifpro-book.eot?#iefix') + '") format("embedded-opentype"), url("' + require('../fonts/MetaSerifPro/MetaSerifPro-Book/metaserifpro-book.woff') + '") format("woff")',
    fontStyle: 'normal',
    fontWeight: 'normal',
};
...
export const LucidaGrandeFontB = {
    fontFamily: "LucidaGrande",
    src: ' url("' + require('../fonts/lucida-grande/lucida-grande-bold.eot') + '"), url("' + require('../fonts/lucida-grande/lucida-grande-bold.eot?#iefix') + '") format("embedded-opentype"), url("' + require('../fonts/lucida-grande/lucida-grande-bold.woff') + '") format("woff")',
    fontStyle: 'bold',
    fontWeight: 'bold',
};